const products = {
  ...
  "night-red": {
    ...
    storage: "2–3 недели в прохладном месте. Ранний сорт, не предназначен для длительного хранения — лучше употреблять свежим.",
    benefits: "Богаты витамином C, железом и клетчаткой. Легко усваиваются, подходят для детского и диетического питания.",
    size: "Плоды обычно крупного (до 180–200 г) или среднего размера (120–150 г), округлой, слегка приплюснутой формы. Кожица тонкая, но плотная. Основная окраска светло-зелёная, покровный румянец карминово-красный или малиновый занимает 65–85% площади плода.",
  },
  "golden": {
    name: "Яблоки «Голден»",
    tag: "Фрукты",
    ...
    taste: "Нежно-сладкий с лёгкой кислинкой. Мякоть у спелого плода плотная, кремово-жёлтая, сочная и ароматная. При надкусывании — хрустящая, но со временем может становиться более мягкой, даже слегка мучнистой.",
    season: "Октябрь — ноябрь",
    storage: "Плоды могут храниться до апреля, а при соблюдении условий — до июня.",
    benefits: "Богаты витамином C, железом и клетчаткой. Легко усваиваются, подходят для детского и диетического питания.",
    size: "Яблоки округло-конические, среднего или крупного размера (140–190 г).",
  },
  "hanni": {
    ...
    taste: "Нежно-сладкий с лёгкой кислинкой. Мякоть у спелого плода плотная, кремово-жёлтая, сочная и ароматная. При надкусывании — хрустящая, но со временем может становиться более мягкой, даже слегка мучнистой.",
    season: "Октябрь — ноябрь",
    storage: "Плоды могут храниться до 6–7 месяцев при правильном хранении.",
    benefits: "Богаты витамином C, железом и клетчаткой. Легко усваиваются, подходят для детского и диетического питания.",
    size: "Яблоки крупные, массой 180–300 г, округло-конической формы с удлинением.",
  },
};
